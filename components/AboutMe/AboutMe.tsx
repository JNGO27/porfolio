    ...
    <div className={styles["about-me"]}>
      ...
      <div className={styles.container}>
        <div className={styles.content}>
          <p>I wasn`&apos`t always a Software Engineer. I spent many years as a musician performing music, teaching music, and constantly thinking about music. I got quite skilled at the <a className="styled-link" target="_blank" href="https://www.youtube.com/watch?v=O4jGiTPMI6g" rel="noopener noreferrer">Classical Guitar</a> and still really love it! While on my music journey,
            I became enthusiastically excited around the concept of identity and thought about what I would do if I wasn`&apos`t doing music and could I enjoy it as much as music?. This question lead me to think about the many possible versions of myself and long story short, I landed in the world of programming!
          </p>
          <p>Fast forward today, I`&apos`m very excited to say that I ended up loving this craft as much as music! I have spent years trying to become as skilled as possible in this craft by completing multiple training program and building projects that I`&apos`m proud of.
